...
class SignUpForm(forms.Form):
    login = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Enter Login'}), max_length=48)
    email = forms.EmailField(widget=forms.TextInput(attrs={'placeholder': 'Enter Email'}), max_length=56)
    passwd = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Enter Password'}), max_length=48)
    repeat_passwd = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Confirm Password'}), max_length=48)
