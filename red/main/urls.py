...
urlpatterns = [
                  ...
                  path('Product-Details/<slug>', ProdDetailsView.as_view(), name='product-details'),
                  ...
                  path('admin/main/change-photo/<model>/<slug>', ChangePhotoView.as_view(), name='change-photo'),
